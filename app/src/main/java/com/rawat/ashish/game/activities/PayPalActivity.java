...
public class PayPalActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sendRequest = findViewById(R.id.payPalButton);
    }

    public void sendRequestPayPal(View view) {
        sendPost(sharedPreferences.getString(MyConstants.USER_ID, ""),
                getStringFromEditText(paypalEmail)
        );
        loadProgressBar();
    }
    ...
    private void setEveryThingToDefault() {
        ...
        setTextIntoEditText(paypalEmail);
    ...
    private void sendPost(String userId,
        ...
        mAPIService.payPalPaymentRequest(userId,
                payPalEmail).enqueue(new Callback<PaymentRequest>() {
            @Override
